...
function OwnerTeamComponent(props) {
    ...
    const { fixId, archived_unarchived_users, deleteUser, isUserArchive, inviteStatus, handleSendInvitation, payrate, reSendInvitation, users, setUsers, selectedUser } = props
                    ...
                    {isUserArchive === true && (
                        <>
                            ...
                            <div>
                                ...
                                {selectedUser?.userType === "owner" ? null :
                                    (user._id !== fixId &&
                                        (
                                            user?.userType !== "owner" ||
                                            user?.userType === "admin"
                                    ...
                                    ) : user?.userType === "manager" ? null : null}
