            ...
            <div className="fullForm">
              ...
              <div>
                ...
                <p><textarea value={message} style={{
                  ...
                  borderRadius: "10px",
                  outline: "none",
                }} rows="4" cols="70" type="text" placeholder="Enter Your Message" onChange={(t) => setmessage(t.target.value)} /></p>
              </div>
            </div>
            <div>
              <button
                onClick={handleSubmit}
                disabled={loading} type="submit" className={loading ? "disabledAccountButton" : "accountButton"}>{loading ? <FerrisWheelSpinner loading={loading} size={28} color="#6DBB48" /> : "Send"}</button>
        ...
        <div className="publicRelation">
          <div className="halfPart">
            ...
            <div style={{ display: "flex", alignItems: "center", }}>
              ...
              <p style={{ margin: "0", fontWeight: '600', fontSize: "18px" }}>info@sstrack.io</p>
            </div>
          </div>
          <div>
